    ...
    <div class="main">
        ...
        <div class="img">
            <a target="_blank" href="#">
                <img src="men/Puma Arsenal Home Shirt 2016 2017_1.jpg" alt="Fjords" width="300" height="200">
            </a>
        ...
        <div class="img">
            <a target="_blank" href="#">
                <img src="men/New Balance Liverpool Home Shirt 2016 2017 Mens_1.jpg" alt="Fjords" width="300" height="200">
            </a>
            <div class="desc">Add a description of the image here</div>
        </div>
        </div>
        ...
        <div class="img">
            <a target="_blank" href="#">
                <img src="men/adidas Chelsea Home Shirt 2016 2017 Mens_1.jpg" alt="Fjords" width="300" height="200">
            </a>
            <div class="desc">Add a description of the image here</div>
        </div>
        </div>
        ...
        <div class="img">
            <a target="_blank" href="#">
                <img src="men/adidas Manchester United Home Shirt 2016 2017 Mens_1.jpg" alt="Fjords" width="300" height="200">
            </a>
            <div class="desc">Add a description of the image here</div>
        </div>
        </div>
