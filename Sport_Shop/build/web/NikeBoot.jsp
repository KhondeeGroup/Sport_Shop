...
<div class="header">
  <h1 align="center">Football Shops</h1>
    ...
    <div class="main">
        ...
        <div class="img">
            <a target="_blank" href="#">
                <img src="boot/NIKE MAGISTA OBRA II FG 3.jpg" alt="Fjords" width="300" height="200">
            </a>
            <div class="desc">Add a description of the image here</div>
        </div>
        </div>
        ...
        <div class="img">
            <a target="_blank" href="#">
                <img src="boot/NIKE MERCURIAL VICTORY VI CR7 FG 2.jpg" alt="Fjords" width="300" height="200">
            </a>
            <div class="desc">Add a description of the image here</div>
        </div>
        </div>
        ...
        <div class="img">
            <a target="_blank" href="#">
                <img src="boot/NIKE MERCURIAL VICTORY VI CR7 FG 3.jpg" alt="Fjords" width="300" height="200">
            </a>
            <div class="desc">Add a description of the image here</div>
        </div>
        </div>
        ...
        <div class="img">
            <a target="_blank" href="#">
                <img src="boot/NIKE MERCURIAL VICTORY VI CR7 FG.jpg" alt="Fjords" width="300" height="200">
            </a>
            <div class="desc">Add a description of the image here</div>
        </div>
        </div>
